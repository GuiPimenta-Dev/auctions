...
class Layers:
    def __init__(self, scope) -> None:
        ...
        self.fuzzywuzzy_layer = _lambda.LayerVersion.from_layer_version_arn(
            scope,
            id="FuzzywuzzyLayer",
            layer_version_arn="arn:aws:lambda:us-east-2:211125768252:layer:fuzzywuzzy:1",
        )
        ...
        self.lxml_layer = _lambda.LayerVersion.from_layer_version_arn(
            scope,
            id='LxmlLayer',
            layer_version_arn='arn:aws:lambda:us-east-2:211125768252:layer:lxml:1',
         )
